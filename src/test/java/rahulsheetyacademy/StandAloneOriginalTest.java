...
public class StandAloneOriginalTest 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		// Target product name to select
				...
				driver.findElement(By.id("userEmail")).sendKeys("sb@gamail.com");
				Thread.sleep(3000);

				// Enter password in the password field
				driver.findElement(By.id("userPassword")).sendKeys("d!DAKFYAjzRNc9J");
				Thread.sleep(3000);
				...
				WebElement selectedProduct = productList.stream()
				        .filter(product -> product.findElement(By.xpath("(//div[@class = 'card-body']/h5)[1]"))
